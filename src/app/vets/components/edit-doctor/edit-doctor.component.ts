...
export class EditDoctorComponent implements OnInit {
  ...
  DisplayData: any;
  vetDetails: any;
  constructor(private update: AddVetService, private activeRoute: ActivatedRoute,private router: Router) { }
  ...
  ngOnInit(): void {
    ...
    this.update.getCurrentData(this.vetId).subscribe(result => {
      ...
      this.updateForm = new FormGroup({
        ...
        firstName: new FormControl(this.vetDetails["firstName"],[Validators.required,Validators.minLength(3),Validators.maxLength(20)]),
        lastName: new FormControl(this.vetDetails["lastName"]),
        department: new FormControl(this.vetDetails["department"],[Validators.required,Validators.minLength(3),Validators.maxLength(20)]),
        email: new FormControl(this.vetDetails["email"]),
        gender: new FormControl(this.vetDetails["gender"],[Validators.required]),
        ...
        mobileNo: new FormControl(this.vetDetails["mobileNo"],[Validators.required,Validators.minLength(10),Validators.pattern("[6-9]{1}[0-9]{9}")]),
