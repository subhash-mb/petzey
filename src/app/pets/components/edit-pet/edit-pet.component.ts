...
ngOnInit(): void {
  ...
  this.pet.getPetInfoById(this.petId).subscribe(result=>{
    ...
    parentPhoneNumber:new FormControl(this.petDetails["parentPhoneNumber"]),
